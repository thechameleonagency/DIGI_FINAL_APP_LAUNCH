...
export function InvoiceDocument({
  ...
  const verifyUrl =
    typeof window !== 'undefined' ? `${window.location.origin}/verify-bill` : '/verify-bill';

  return (
    <div className="stack card card-pad" id={`invoice-${invoice.id}`}>
      ...
      <div className="grid-2">
        ...
        <div className="stack">
          ...
          <div className="card card-pad" style={{ fontSize: 11, wordBreak: 'break-all' }}>
