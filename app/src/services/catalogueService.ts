...
export async function upsertProduct(params: {
  ...
  const product: Product = {
    ...
    scheduleType: params.product.scheduleType ?? (params.product.narcotic ? 'NDPS' : 'NONE'),
    listedForSale: params.product.listedForSale !== false,
    imageIds: params.product.imageIds,
    status: 'Active',
